...
@expressionism_api_blueprint.get("/disciplines/<int:discipline_id>/sections")
...
@expressionism_api_blueprint.post("/disciplines/<int:discipline_id>/new/section")
...
@expressionism_api_blueprint.post("/disciplines/<int:discipline_id>/new/course_variant")
...
@expressionism_api_blueprint.route("/edit/section/<int:section_id>", methods=["PATCH"])
...
@expressionism_api_blueprint.route("/delete/section/<int:section_id>", methods=["DELETE"])
...
@expressionism_api_blueprint.route("/sections/<int:section_id>/new/topic", methods=["POST"])
...
@expressionism_api_blueprint.route("/edit/topic/<int:topic_id>", methods=["PATCH"])
...
@expressionism_api_blueprint.route("/delete/topic/<int:topic_id>", methods=["DELETE"])
...
@expressionism_api_blueprint.get("/topics/<int:topic_id>")
...
@expressionism_api_blueprint.route("/topics/<int:topic_id>/new/generator", methods=["POST"])
...
@expressionism_api_blueprint.patch("/edit/generator/<int:generator_id>")
...
@expressionism_api_blueprint.delete("/delete/generator/<int:generator_id>")
...
@expressionism_api_blueprint.get("/generators/<int:generator_id>")
...
@expressionism_api_blueprint.route("/topics/<int:topic_id>/new/task", methods=["POST"])
...
@expressionism_api_blueprint.route("/edit/task/<int:task_id>", methods=["PATCH"])
...
@expressionism_api_blueprint.route("/delete/task/<int:task_id>", methods=["DELETE"])
...
@expressionism_api_blueprint.get("/tasks/<int:task_id>")
...
@expressionism_api_blueprint.get("/disciplines/<int:discipline_id>/course_variants")
...
@expressionism_api_blueprint.route("/edit/course_variant/<int:course_variant_id>", methods=["PATCH"])
...
@expressionism_api_blueprint.route("/delete/course_variant/<int:course_variant_id>", methods=["DELETE"])
...
@expressionism_api_blueprint.route("/tasks/<int:task_id>/add/<int:generator_id>", methods=["POST"])
...
@expressionism_api_blueprint.route("/delete/task_generator/<int:task_generator_id>", methods=["DELETE"])
...
@expressionism_api_blueprint.get("/tasks/<int:task_id>/results")
def get_task_results(task_id):
    results = db.session.query(GenerationResult).filter_by(task_id=task_id).all()
    return [r.to_json() for r in results]


@expressionism_api_blueprint.delete("/delete/results/<int:result_id>")
...
@expressionism_api_blueprint.patch("/edit/results/<int:result_id>")
...
@expressionism_api_blueprint.get("/results/<int:result_id>/variants")
...
@expressionism_api_blueprint.post("/tasks/<int:task_id>/new/generation")
...
@expressionism_api_blueprint.get("/variants/<int:variant_id>/document")
...
@expressionism_api_blueprint.get("/variants/<int:variant_id>/answers")
...
@expressionism_api_blueprint.get("/results/<int:result_id>/export")
